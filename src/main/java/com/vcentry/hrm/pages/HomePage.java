...
public class HomePage extends CommonFunctions {
	...
	public HomePage addEmp(String name1,String name2
	...
	public HomePage searchEmployee(String name1,String name2) throws InterruptedException {
		clickElement(empList);
	...
	public HomePage deleteEmployee(String name1) {
	    String checkbox="(//a[text()='"+name1
	    		+"']/parent::td/preceding-sibling::td)[1]";
		String id="(//a[text()='"+name1
			+"']/parent::td/preceding-sibling::td)[2]/a";
		...
		List<WebElement> empid=driver.findElements(By.xpath(id
				+"[text()='"+empID+"']"));
